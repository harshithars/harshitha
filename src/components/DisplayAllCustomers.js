...
function DisplayAllCustomers() {
    ...
    const handleUpdate = (updateCustomer) => {
        ...
        setIsUpdate(true);
        setUpdateCutomer(updateCustomer);
    }
    ...
    const updateCustomerElement = (
        <>
            ...
            <form onSubmit={handleUpdateSubmit}>
                ...
                <div className="form-group">
                <input type="email" name="email"  className="form-control col-4" value={updateCustomer.email} onChange={(event) => handleChange(event)} placeholder="emailId" required ></input><br />
                </div>
                <div className="form-group">
                                        ...
                                        (cust) => {
                                            return (
                                                <tr key={cust.customerId}>
                                                    ...
                                                    <td>{cust.regDate}</td>
                                                    <td>
                                                        <input type="button" onClick={() => handleUpdate(cust)} className="btn btn-success" value="Update"></input>
